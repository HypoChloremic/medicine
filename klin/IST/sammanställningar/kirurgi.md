...
* 82åå man
  * inkommer aktuen med låga buksmärtor och oro
  * bladder scan visar >1L i blåsan
  * Frågor
...
* 55-årig kvinna söker på akutmottagningen p.g.a. smärta i flanken. Framkommer vid riktad anamnes att patienten knuffats av särbo, oklart om detta skett även tidigare. Patienten dricker öl/vin till maten (ett par glas fredag/lördag) ej annan alkohol. Röker ej. I hemmet finns hemmavarande barn under 18 år detta måste explicit efterfrågas. Särbo överkonsumtion alkohol. Patienten är smärtpåverkad men ej andningspåverkad. I status diskret rodnat område vänster flank. Patienten ömmar över revben samt avvärjer och anger obehag vid djuppalp vänster flank.
...
* Status
  * lungor
    ...
    * perkuterar
    * ömhet revben
    * indir ömhet vid tryck thorax
  * Bukstatus
    * auskulterar
    * perkuterar
    * dunköm njurloge o arkii
    * nämner PR
    * PM
    * palp system 2 varv, ytligt djupt
    * ljumskar
    * indir dir ömhet o släppöm
* Kliniskt resonemang
  * DD 
    * mjältruptu
    * njurskada
    * lungblödn
    * revbensfraktur
    * stud bör ha utforsk trauma samt id misshandel och orosanmälan mindreråriga hemmavarande barn
* Patkom
  * involvera pat planering
  * förvissar om pat har frågor, involverar pat i att socialtjänsten behöver kopplas in
* Bedömning o åtgärd
  * resonemank sannolik etiologi
  * behov komma t diagnos
    * mjältruptur
    * DD: 
      * njurskada
      * lungblödning
      * revbensfraktur
    * beakta hemmavarande barn under 18åå
* Adekvata åtgärder
  * Labb
    * Hb
    * blodstatus
  ...
  * fasta
  * dropp
  * resonemang kr inlägg
    * beroende DT svar
  * erbjuda kontakt kurator 
  * orosanmäöla
  * erbjuda hjälp med polisanmälan
  * erbjuda kontakt kurator
  * erb hjälp med polisanmälan
  * krävs ej APTT blod grupp i initial handlägg
  * UL är ej eg korrekt modalitet
...
* En tidigare frisk 45-årig man inkommer till akuten pga sårskada vänster fotrygg. Patienten uppger att han skadat sig i köket då han hade diskat en ny kökskniv. Kniven tappades ner på foten. Berätta vad du gör och motivera dina handlingar.
* Berätta vad du gör o motivera dina handlingar



***Översikt***

* Sårskada blöder ej, har fina sårkanter
* Lokaliserad mitt på fotryggen
* !! Skada ska bedömas efter rengöring
* Distalstatus: sensorik, motorik
* Ordination tetanusprofylax
* suturmaterial ska ordineras
* rätt tid för suturtagning ska anges
* diskutera inflammation, sårläkning o ärrbildning
* pat ska informeras om ev komplikationer
...
* Studentinstruktion Du är AT-läkare arbetande på akutmottagningen: Din nästa patient är en 61-årig lärare med sårskada i handen. Genomför en konsultation med patienten! Berätta vad du gör och motivera dina beslut!



***Översikt***

* anamnes, distalstatus, 
...
* Anamnes: viktigt att efterfråga förstås
* Aktuellt
  * sårskadans ålder:
    * om >8h, ska ej sy ihop såvida det inte är hand eller ansikte
  * <24h om bättre genomblött område, e.g. ansikte..
  * ta reda på hur det gick till
  * renhetsgrad på det skadande föremåplet osv
  * känselnedsättning, rörlighet i hand
  * soc, tidg nuv sjd, socialt, mediciner (inkl AT-vacciner), allergi
* Status
  * Distalstatus: medianus, ulnaris, radialis, a radialis, motorik
* man ska kuna principer sårtoalett / excision / rengöring, o olika bedövning
  * e.g. lokalanestetika, regional anestesi, generell anestesi, bedövningsmedel
* Diskussion lokalanestesi +- adrenalin
  *  Denna gamla regel baserades på erfarenheter med procain på början av 1900-talet och man visste inte då att detta medel blev oerhört surt (pH 1) vid lagring. De fall av ischemi som rapporterades berodde på gammalt procain och inte på adrenalintillsatsen
* kunna utföra, diskutera, informera ang. fördelar nackdelar
  * blodtomt fält
  * ren steril teknik
  * suturmaterial: monofil, flätad tråd, sgrobvlek. sturu som inte går upp
  * suturtagning: tid arm 10-14d, åb dsk, sårläkning, ärrbildning
  * komplikationer: infektion, ärr, solning
  * antibiotikaprofy: tex nedsatt immun, dålig beh diabetes
  * tetanusvacc: viktigt efterfråga, tetanus ovanlig sjd i västerlandet, me fatal
  * AT-vaccin: 
    * den skadade är tid ovacc o dr bedömer risk för tetanys
      * 1mL tetanusvaccin i, i vä arm + 1mL immunglob mot tetanus im i lår
      * grundvaccination mot stelkramp fortsätter med nästa tetanusvaccin om 1 månad, o
      * injektion 3 om 1 år
      * ak-tetanus tas först
    * tidg 1 el 2 stelkrampsvaccin
      * 1mL tetanusvaccin im arm
      * starkt förorenad skada om ej kan excideras även 1mL immunglob i m i lår
      * tidg fått 3 stelkrampsvaccin
        * om<10år ges 0.5mL ooster
        * tidg 4 el feler stelkramp
          * <2+å sedan ge 0.5mL booster





### Fall 3 - buken sårskada

***Presentation***

* 62-årig snickare, med välreglerad tablettbehandlad hypertoni, gift, sparsamt alkohol, vilken under arbete i sin finsnickeriverkstad råkat slinta med ett stämjärn, och genom tangentiellt våld åsamkat sig en skada i buken. Patienten har blött något i samband med detta, tagit en handduk som tryck, handduken är delvis nedblodad, och patienten har tagit sig till akutmottagningen med hjälp av en granne. Patienten är cirkulatoriskt stabil. 
...
* Anamnes
  * tankar, oro, önskan
  * Stämjärnets renhetsgrad
  * hur mkt blött
  * AT-vaccineringar
  * tidg sjd, lkm (blodförtunnande), allergier
  * tobak, alk
* Status
  * AT, cor, pulm, BT, pååekar åtminstone att detta ska utföras
  * busktatus 1
    * inspektion
    * perkussion
    * auskultation
  * bukstatus 2
    * palpation ytligt o djupt varv
  * !! undersöker skadan, 
    * ytlig 
    * djupt, 
    * sonderar, ner till muskulatur
  * Bedömer föroreningsgrad
    * förorenad men ej infekterad
* !! Bedömning
  * erbjuder AT-vaccin, över 30åå sedan AT
  * frågar om pat har förstått, har några frågor
  * motiverar varför DT-buk eller ej
  * motiverar anitibiotika eller ej
  * sätta 3 suturer som håller för debridering
  * suturer ut om 8-12d
  * söka vid inf tecken
